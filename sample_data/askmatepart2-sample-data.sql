...
(
    ...
    username        varchar,
    password        varchar,
    registration_ts timestamp default now()
);
...
alter table public.question
    add constraint question_question_user_id_fk
        foreign key (user_id) references public.app_user;

alter table answer
    add constraint answer_app_user_user_id_fk
        foreign key (user_id) references app_user;

alter table comment
    add constraint comment_app_user_user_id_fk
        foreign key (user_id) references app_user;
